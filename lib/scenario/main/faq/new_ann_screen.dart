        ...
        Row(
          ...
          children: [
            ...
            IconButton(
                ...
                onPressed: () {
                  if (titleTextController.text.isEmpty || contentController.text.isEmpty) {
                  ...
                  final announcement = Announcement(
                      ...
                      createdAt: widget.ann == null ? DateTime.now().toString() : widget.ann!.createdAt,
                      date: widget.ann == null ? DateFormat('yyyy-MM-dd').format(DateTime.now()) : widget.ann!.date,
                      image: null);
                  final isUpdate = widget.ann != null;
                  AnnouncementService().saveAnnouncement(announcement).then((value) async {
                    await showDialog(
                        context: context,
                        builder: (context) => ContentDialog(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'image',
                    style: TextStyle(color: Colors.grey[400], fontWeight: FontWeight.w500, fontSize: 12.0),
                  )
                ],
              ),
            ))
        : GestureDetector(
            ...
            child: Container(
                ...
                child: Stack(children: [
                  Center(
                      child: Container(
                          decoration: BoxDecoration(image: DecorationImage(fit: BoxFit.cover, image: Image.file(File(img.path)).image), borderRadius: BorderRadius.circular(10)),
                          width: imgBoxSize,
                          height: imgBoxSize)),
                  Positioned(
                      top: 0,
                      ...
                      child: Container(
                          ...
                          child: Icon(FluentIcons.close_pane, size: 15, color: Colors.grey[400])))
                ])));
  }
}